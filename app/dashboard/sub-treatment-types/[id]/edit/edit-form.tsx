...
import { updateSubTreatmentType, State } from '@/lib/actions'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Label } from '@/components/ui/label'
import Link from 'next/link'

export default function EditSubTreatmentTypeForm({ treatmentTypes, subTreatmentType }: { treatmentTypes: any[], subTreatmentType: any }) {
    const initialState: State = { message: null, errors: {} }
    const updateSubTreatmentTypeWithId = updateSubTreatmentType.bind(null, subTreatmentType.sub_treatment_type_id)
    const [state, formAction] = useActionState(updateSubTreatmentTypeWithId, initialState)
        ...
        <form action={formAction}>
            <div className="rounded-md bg-secondary/50 p-4 md:p-6 space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <select
                            ...
                            defaultValue={subTreatmentType.treatment_type_id}
                ...
                <div>
                    ...
                    <Input id="name" name="name" defaultValue={subTreatmentType.sub_treatment_type_name} placeholder="Enter sub treatment name" className="w-full" aria-describedby="name-error" required />
                ...
                <div>
                    ...
                    <Input id="rate" name="rate" type="number" step="0.01" min="0" defaultValue={subTreatmentType.rate ? subTreatmentType.rate.toString() : ""} placeholder="0.00" className="w-full" aria-describedby="rate-error" required />
                ...
                <div className="flex items-center gap-2">
                    <input type="checkbox" id="isActive" name="isActive" className="h-4 w-4 rounded border-input bg-background text-foreground focus:border-ring focus:ring-1 focus:ring-ring text-primary focus:ring-indigo-500" defaultChecked={subTreatmentType.is_active} />
                ...
                <div>
                    ...
                    <Input id="description" name="description" defaultValue={subTreatmentType.description || ''} placeholder="Enter description (optional)" className="w-full" />
                </div>
            ...
            <div className="mt-6 flex justify-end gap-4">
                ...
                <Button type="submit">Update Sub Treatment Type</Button>
            </div>
        </form>
    )
}
