...
import { createDiagnosisType, State } from '@/lib/actions'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Label } from '@/components/ui/label'
import Link from 'next/link'

export default function CreateDiagnosisTypeForm({ hospitals }: { hospitals: any[] }) {
    const initialState: State = { message: null, errors: {} }
    const [state, formAction] = useActionState(createDiagnosisType, initialState)
        ...
        <form action={formAction}>
            <div className="rounded-md bg-secondary/50 p-4 md:p-6 space-y-4">
                ...
                <div>
                    ...
                    <Input id="name" name="name" placeholder="Enter diagnosis name" className="w-full" aria-describedby="name-error" required />
                ...
                <div>
                    ...
                    <Input id="shortName" name="shortName" placeholder="Enter short name (optional)" className="w-full" />
                </div>
            ...
            <div className="mt-6 flex justify-end gap-4">
                ...
                <Button type="submit">Add Diagnosis Type</Button>
            </div>
        </form>
    )
}
