...
import { updatePatient, State } from '@/lib/actions'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Label } from '@/components/ui/label'
import Link from 'next/link'

export default function EditPatientForm({ hospitals, patient }: { hospitals: any[], patient: any }) {
    const initialState: State = { message: null, errors: {} }
    const updatePatientWithId = updatePatient.bind(null, patient.patient_id)
        ...
        <form action={formAction} className="p-6">
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <select
                            ...
                            defaultValue={patient.hospital_id}
                ...
                <div>
                    ...
                    <Input id="patientName" name="patientName" defaultValue={patient.patient_name} placeholder="Enter patient name" className="w-full" aria-describedby="patientName-error" required />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <Input id="mobileNo" name="mobileNo" type="tel" pattern="\d{10}" title="Must be exactly 10 digits" minLength={10} maxLength={10} defaultValue={patient.mobile_no} placeholder="Enter mobile no" className="w-full" aria-describedby="mobileNo-error" required />
                    ...
                    <div>
                        ...
                        <Input id="emergencyContactNo" name="emergencyContactNo" defaultValue={patient.emergency_contact_no || ''} placeholder="Optional" className="w-full" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <Input id="age" name="age" type="number" min="0" max="150" defaultValue={patient.age || ''} placeholder="Age" className="w-full" />
                    </div>
                ...
                <div>
                    ...
                    <Input id="address" name="address" defaultValue={patient.address || ''} placeholder="Enter address" className="w-full" />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <Input id="occupation" name="occupation" defaultValue={patient.occupation || ''} placeholder="Optional" className="w-full" />
                    </div>

                    {/* Referred By */}
                    <div>
                        <Label htmlFor="referredBy" className="mb-2 block text-sm font-medium">Referred By</Label>
                        <Input id="referredBy" name="referredBy" defaultValue={patient.referred_by || ''} placeholder="Optional" className="w-full" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <Input id="description" name="description" defaultValue={patient.description || ''} placeholder="Enter description (optional)" className="w-full" />
                </div>
